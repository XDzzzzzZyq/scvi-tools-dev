...
_RESOLVAE_PYRO_MODULE_NAME = "resolvae_v2"


class RESOLVAEModel_V2(PyroModule):
...
class RESOLVAEGuide_V2(PyroModule):
...
class RESOLVAE_V2(PyroBaseModuleClass):
    """
